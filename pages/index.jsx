...
import Navbar_app from "../features/NavBar/Navbar_app";
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        حلقه انجام میشود که تمام object ها completed: true
                        میشود.
                      </li>
                      <li>
                        todos/clearCompleted: با کلیک روی دکمه Clear Completed
                        یک dispatch انجام میشود که همرا خود چیزی ندارد فقط یک
                        حلقه انجام میشود که تمام object ها را پاک می کند.
                      </li>
                    </ul>
                  </li>
                  <li>
